...
public class Tutor_CharFromUnicodeCasesExchangedTests extends AbstractTestClass {
    ...
    public static final String CONSTRUCTOR_SIGNATURE = "CharFromUnicodeCasesExchanged()";
    ...
    public Tutor_CharFromUnicodeCasesExchangedTests() {
        super(
            "h11.unicode.CharFromUnicodeCasesExchanged",
    ...
    public void testDefinitions() {
        ...
        assertMethod(assertClassHasMethod(this, METHOD_APPLY_SIGNATURE), Modifier.PUBLIC, null, null, (Predicate<Type>) null);
    }
